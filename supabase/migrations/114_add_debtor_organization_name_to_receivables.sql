-- Миграция 114: Добавление поля debtor_organization_name в функцию get_organization_receivables
-- Для отображения наименования организации клиента-должника
...
COMMENT ON FUNCTION public.get_organization_receivables(UUID, TIMESTAMPTZ, TIMESTAMPTZ) IS 
  'Возвращает дебиторку (неоплаченные заказы) для организации. Включает наименование организации клиента-должника.';
