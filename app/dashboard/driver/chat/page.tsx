...
export default function DriverChatPage() {
  ...
  if (!profile?.organization_id) {
    return (
      <div className="pb-20">
        <h1 className="text-3xl font-bold mb-6 text-white">Чаты</h1>
    ...
    <div className="pb-20">
      ...
      <div className="space-y-4">
        ...
        {personalChats.length > 0 && (
          <div className="bg-gray-800 rounded-lg shadow p-4">
            <h2 className="text-xl font-semibold text-white mb-4">Личные сообщения</h2>
              ...
              {personalChats.map((chat) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-white font-medium">Организация</h3>
                      {chat.lastMessage && (
        ...
        <div className="bg-gray-800 rounded-lg shadow p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white">Личный чат с организацией</h3>
                <p className="text-sm text-gray-400">Приватный чат с вашей организацией</p>
              </div>
            </div>
            <button
